...
titulo: O Ministério Público, se não ajuizar a ação, atuará sempre como fiscal da
  lei
livro: LIVRO-II
tipo_norma: processual
aplicacao:
- geral
relevancia: média
status: vigente
...
> O Ministério Público, se não ajuizar a ação, atuará sempre como fiscal da lei. Parágrafo único. (Vetado) .
