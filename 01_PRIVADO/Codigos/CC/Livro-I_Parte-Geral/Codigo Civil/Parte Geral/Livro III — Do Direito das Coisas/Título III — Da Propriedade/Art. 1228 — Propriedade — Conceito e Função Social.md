---
artigo: "1228"
nomen: "Propriedade — Conceito e Função Social"
parte: "Parte Geral"
...
# Art. 1228 CC — Propriedade — Conceito e Função Social

> [!info] Localização
> Parte Geral › Livro III — Do Direito das Coisas › Título III — Da Propriedade › Capítulo: Da Propriedade em Geral › Seção: Disposições Preliminares
...
| Campo | Valor |
|---|---|
| Dispositivo | Art. 1228 do Código Civil (Lei 10.406/2002) |
| Parte | Parte Geral |
| Livro | Do Direito das Coisas |
| Título | Da Propriedade |
| Capítulo | Da Propriedade em Geral |
| Seção | Disposições Preliminares |
| Grupo temático | Direito das Coisas |
| Natureza | direito |

> [!tip] Análise — Propriedade — Conceito e Função Social
> Propriedade: usar, gozar, dispor e reaver — amplo mas não absoluto.

> [!warning] Atenção
> Função social limita: imóvel improdutivo pode ser desapropriado (CF art. 182/186).

> [!example] Ponto de Prova
> Usucapião extingue propriedade do omisso em favor do possuidor ativo.

## Links Relacionados

← [[Art. 1227]] | [[INDEX — Código Civil]] | [[Art. 1229]] →
