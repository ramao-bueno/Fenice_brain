...
# Art. 2046 CC — Anulação da Partilha

> [!info] Localização
> Parte Geral › Título IV — Do Inventário e da Partilha › Capítulo: Da Anulação da Partilha

> [!quote] Texto Legal
> **Art. 2046.** Todas as remissões, em diplomas legislativos, aos Códigos referidos no artigo antecedente,
...
| Campo | Valor |
|---|---|
| Dispositivo | Art. 2046 do Código Civil (Lei 10.406/2002) |
| Parte | Parte Geral |
| Livro | — |
...
← [[Art. 2045]] | [[INDEX — Código Civil]] | *(fim)* →
