...
> Caberá ao Juiz da execução determinar a intimação do condenado, cientificando-o do local, dias e horário em que deverá cumprir a pena. Parágrafo único. A execução terá início a partir da data do primeiro comparecimento.
