...
titulo: Deixar de corrigir imediatamente informação sobre consumidor constante de
...
# CDC Art. 73 — Deixar de corrigir imediatamente informação sobre consumidor constante de cadastro, banco de dados, fichas ou registros
