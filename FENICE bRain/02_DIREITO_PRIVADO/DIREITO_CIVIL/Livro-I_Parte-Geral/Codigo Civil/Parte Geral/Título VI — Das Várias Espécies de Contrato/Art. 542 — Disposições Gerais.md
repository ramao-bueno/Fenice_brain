...
# Art. 542 CC — Disposições Gerais

> [!info] Localização
> Parte Geral › Título VI — Das Várias Espécies de Contrato › Capítulo: Da Doação › Seção: Disposições Gerais
...
| Campo | Valor |
|---|---|
| Dispositivo | Art. 542 do Código Civil (Lei 10.406/2002) |
| Parte | Parte Geral |
| Livro | — |
...
← [[Art. 541]] | [[INDEX — Código Civil]] | [[Art. 543]] →
