...
# Art. 1481 CC — Disposições Gerais

> [!info] Localização
> Parte Geral › Título X — Do Penhor, da Hipoteca e da Anticrese › Capítulo: Da Hipoteca › Seção: Disposições Gerais

> [!quote] Texto Legal
> **Art. 1481.** Dentro em trinta dias, contados do registro do título aquisitivo, tem o adquirente do imóvel
...
| Campo | Valor |
|---|---|
| Dispositivo | Art. 1481 do Código Civil (Lei 10.406/2002) |
| Parte | Parte Geral |
| Livro | — |
...
← [[Art. 1480]] | [[INDEX — Código Civil]] | [[Art. 1482]] →
