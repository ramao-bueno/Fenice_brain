...
# CPC Art. 57 — Quando houver continência e a ação continente tiver sido proposta anteriormente, no processo
...
> relativo à ação contida será proferida sentença sem resolução de mérito, caso contrário, as ações serão necessariamente reunidas.
...
- [[Art. 56]] — Artigo anterior
- [[Art. 58]] — Artigo seguinte
