...
tags: [direito-internacional, direitos-humanos, cadh, index, prova-de-conceito]
created: 2026-06-07
---
...
> vetor de negócio em texto com numeração `ARTIGO N` (formato que o pipeline
> regex não processa de forma confiável — ver nota técnica no
> [[../../INDEX|INDEX de Direito Internacional]]).
...
CADH — Pacto de San José (Decreto 678/1992)
    ...
    ├─ Art. 7 → CPP Art. 282 + Audiência de Custódia (CNJ Res. 213/2015)
    └─ Art. 8 → CPC Art. 9 + sistema de nulidades + duplo grau de jurisdição
            ↓
    Corte Interamericana de Direitos Humanos (petições em caso de descumprimento)
```
...
**Status:** ✅ 4/82 artigos atomizados (prova de conceito validada)
