...
════════════════════════════════════════════════════════════════════════════════
🎓 ANÁLISE ACADÊMICA — ART. 6
════════════════════════════════════════════════════════════════════════════════

📜 Art. 6 — São direitos básicos do consumidor
📚 Direito Privado
⚖️  Lei: Lei 8.078/1990 (Código do Consumidor)
📖 Livro: LIVRO-I
✅ Status: VIGENTE
🏷️  Tags: direito-do-consumidor, lei-8078, livro-livroi, tipo-protetor, aplicacao-direitos-basicos
...
- [[Art. 5]] — Artigo anterior
- [[Art. 7]] — Artigo seguinte
...
💡 PRÓXIMAS BUSCAS SUGERIDAS:
   • node gerar-busca.js "CDC 5" → Art. 5 — Para a execução da Política Nacional das Relações de Consumo, contará o poder
   • node gerar-busca.js "CDC 7" → Art. 7 — Os direitos previstos neste código não excluem outros decorrentes de tratados

┌───────────────────────────────────────────────────────────────────────────────┐
│ 🔗 LINKS DIRETOS
└───────────────────────────────────────────────────────────────────────────────

📂 Nota original: Fenice_brain/02 - Áreas/Base Jurídica/02_DIREITO_PRIVADO/CÓDIGO_CONSUMIDOR/Direitos-do-Consumidor/Art. 6 — São direitos básicos do consumidor.md
🔗 Abrir nota original: obsidian://open?path=Fenice_brain%2F02%20-%20%C3%81reas%2FBase%20Jur%C3%ADdica%2F02_DIREITO_PRIVADO%2FC%C3%93DIGO_CONSUMIDOR%2FDireitos-do-Consumidor%2FArt.%206%20%E2%80%94%20S%C3%A3o%20direitos%20b%C3%A1sicos%20do%20consumidor.md
