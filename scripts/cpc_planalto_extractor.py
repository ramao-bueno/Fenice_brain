...
# -*- coding: utf-8 -*-
"""
Extrator CPC do Planalto.gov.br

Busca o texto oficial do Código de Processo Civil diretamente do Planalto.
"""
import re
import requests
...
PLANALTO_URL = "https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2015/lei/l13105.htm"
_CACHE = Path(__file__).parent / "_cache_cpc_planalto.html"

# Mapeamento de livros do CPC
LIVRO_MAPEAMENTO = {
...
class CPCPlanaltoExtractor:
    ...
    def _fetch_html(self) -> str:
        ...
        print(f"Baixando CPC do Planalto: {self.url}")
