...
HTML_PATH    = Path(r'C:\Users\oicon\OneDrive\Allah - Islamismo\Stand Alone Legaltech\Fenice brain\FENICE bRain\02_DIREITO_CIVIL\L13655.html')
PROJECT_ROOT = Path(__file__).parent.parent
OUTPUT_BASE  = PROJECT_ROOT / 'FENICE bRain' / '02_DIREITO_CIVIL' / 'Artigos' / 'LINDB'
