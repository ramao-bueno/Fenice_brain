...
```dataview
LIST FROM "Fenice bRain/02_DIREITO_PRIVADO/DIREITO_CIVIL"
  OR "Fenice bRain/04_DIREITO_PENAL/CÓDIGO_PENAL"
  OR "Fenice bRain/03_PROCESSO_CIVIL/CÓDIGO_PROCESSO_CIVIL"
