...
# Art. 377 CC — Compensação

> [!info] Localização
> Parte Geral › Título III — Do Adimplemento e Extinção das Obrigações › Capítulo: Da Compensação
...
| Campo | Valor |
|---|---|
| Dispositivo | Art. 377 do Código Civil (Lei 10.406/2002) |
| Parte | Parte Geral |
| Livro | — |
| Título | Do Adimplemento e Extinção das Obrigações |
| Capítulo | Da Compensação |
| Seção | — |
...
← [[Art. 376]] | [[INDEX — Código Civil]] | [[Art. 378]] →
